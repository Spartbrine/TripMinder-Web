...
export class pgSelectFXComponent implements OnInit, AfterContentInit, AfterContentChecked, ControlValueAccessor {
  ...
  set Open(value: boolean) {
    ...
    if (isOpen) {
      ...
      const contentHeight = this.csOptions.nativeElement.offsetHeight;
      const originalHeight = this.placeHolder.nativeElement.offsetHeight;

      const contentWidth = this.csOptions.nativeElement.offsetWidth;
      const originalWidth = this.placeHolder.nativeElement.offsetWidth;
  ...
  _setTriggerWidth(): void {
    ...
    const rect = this._getTriggerRect();
